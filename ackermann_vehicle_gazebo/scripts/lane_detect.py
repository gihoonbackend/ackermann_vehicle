...
class Unicon_CV():
    ...
    def camera_callback(self, data):
        try:
            ...
            # Calculate the steering angle based on the detected lane points
            steering_angle = estimate_line(self.y_repeat, self.left_lane_pred, self.left_lane_pred, image)
